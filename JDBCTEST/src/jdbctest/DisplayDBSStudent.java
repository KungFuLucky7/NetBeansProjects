...
public class DisplayDBSStudent extends JFrame {  //CHANGE THIS!!
    ...
    public DisplayDBSStudent() //CHANGE THIS!
    {
    ...
    private void getTable() {
        ...
        try {
            String query = "SELECT sname,grade FROM Student s, Enrolled e, Course c WHERE s.sno = e.sno and e.cno = c.cno and c.cname= 'DBS'";  //CHANGE THIS!
    ...
    public static void main(String args[]) {
        final DisplayDBSStudent app = new DisplayDBSStudent();  //CHANGE THIS!
