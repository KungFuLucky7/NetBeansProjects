...
public class DisplayStudent extends JFrame {  //CHANGE THIS!!

    private Connection connection;
    private JTable table;

    public DisplayStudent() //CHANGE THIS!!
    {
    ...
    private void getTable() {
        ...
        try {
            String query = "SELECT * FROM Student";  //CHANGE THIS!
    ...
    public static void main(String args[]) {
        final DisplayStudent app = new DisplayStudent();  //CHANGE THIS!
