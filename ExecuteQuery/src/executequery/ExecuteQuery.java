 ...
 *
 * For CSC 775 HW6: Implement ONE of the queries using the Java JDBC/ODBC
 * interface
 *
 * @author Terry Wong
 */
...
public class ExecuteQuery extends JFrame {  //CHANGE THIS!!

    private Connection connection;
    private JTable table;

    public ExecuteQuery() //CHANGE THIS!!
    {
    ...
    private void getTable() {
        ...
        try {
             ...
             */
            String query = "SELECT DISTINCT name, dept "
                    + "FROM (SELECT * FROM (Sales_Rep JOIN Car ON Sales_Rep.name=Car.seller) "
                    + "WHERE color='green') AS DB;";  //CHANGE THIS!
    ...
    public static void main(String args[]) {
        final ExecuteQuery app = new ExecuteQuery();  //CHANGE THIS!
