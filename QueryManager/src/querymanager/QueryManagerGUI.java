 ...
 * @author Terry Wong
 */
public class QueryManagerGUI extends javax.swing.JFrame {
    ...
    /**
     * Creates new form QueryManagerGUI
     */
    public QueryManagerGUI(String q) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        dispose();
        final QueryManagerGUI app = new QueryManagerGUI(query);
                ...
                new WindowAdapter() {
                    public void windowClosing(WindowEvent e) {
                        ...
                        java.awt.EventQueue.invokeLater(new Runnable() {
                            public void run() {
                                final QueryManagerGUI app = new QueryManagerGUI("");
                                app.setVisible(true);
                                app.addWindowListener(
                                        new WindowAdapter() {
                                            public void windowClosing(WindowEvent e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QueryManagerGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
